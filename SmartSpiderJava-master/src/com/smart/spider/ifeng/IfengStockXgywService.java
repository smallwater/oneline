 ...
 * 
 */
public class IfengStockXgywService extends NewsSiteCommandService {

	private String url = "";
	private String splidFlag = "_";
	private int maxPageCount = 841;
	private boolean isTempFlag = false;
	private String externalCategory = "";

	public IfengStockXgywService() {
		CommandName = "com.smart.spider.ifeng.xgyw";

		Description = "凤凰网财经_新股_新股要闻";
	...
	public void Init(String[] args) {
		...
		url = "http://finance.ifeng.com/cmppdyn/419/467/";
	}
