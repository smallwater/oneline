 ...
 * 
 */
public class IfengStockXgplService extends NewsSiteCommandService {
	private String url = "";
	private String splidFlag = "_";
	private int maxPageCount = 76;
	private boolean isTempFlag = false;
	private String externalCategory = "";

	public IfengStockXgplService() {
		CommandName = "com.smart.spider.ifeng.xgpl";

		Description = "凤凰网财经_新股_新股评论";
	...
	public void Init(String[] args) {
		...
		url = "http://finance.ifeng.com/cmppdyn/421/469/";
	}
