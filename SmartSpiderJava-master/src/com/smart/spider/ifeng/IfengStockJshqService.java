 ...
 * 
 */
public class IfengStockJshqService extends NewsSiteCommandService {
	private String url = "";
	private String splidFlag = "_";
	private int maxPageCount = 4022;
	private boolean isTempFlag = false;
	private String externalCategory = "";

	public IfengStockJshqService() {
		CommandName = "com.smart.spider.ifeng.jshq";

		Description = "凤凰网财经_证券_大盘评述";
	...
	public void Init(String[] args) {
		...
		url = "http://finance.ifeng.com/cmppdyn/27/34/";
	}
	 ...
	 * @return
	 */
	private static String GetNextPageHtml(String nextPageUrl, int nextPageNo) {
