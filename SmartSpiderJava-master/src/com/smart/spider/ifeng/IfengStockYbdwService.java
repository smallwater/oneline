 ...
 * 
 */
public class IfengStockYbdwService extends NewsSiteCommandService {

	private String url = "";
	private String splidFlag = "_";
	private int maxPageCount = 46;
	private boolean isTempFlag = false;
	private String externalCategory = "";

	public IfengStockYbdwService() {
		CommandName = "com.smart.spider.ifeng.ybdw";

		Description = "凤凰网财经_新股_研报定位";
	...
	public void Init(String[] args) {
		...
		url = "http://finance.ifeng.com/cmppdyn/420/468/";
	}
	...
	private boolean getURLWoreds_2(String urlPath, Document doc) {
		...
		try {
			...
			// 2015-12-11正文内容为空
			if (null == sbwords || sbwords.toString().isEmpty()) {
				sbwords.append(doc.select("div#artical_real").text());
	...
	private boolean getURLWoreds_1(String urlPath, Document doc) {
		...
		try {
			...
			// 2015-12-11正文内容为空
			if (null == sbwords || sbwords.toString().isEmpty()) {
				sbwords.append(doc.select("div#main_content").text());
